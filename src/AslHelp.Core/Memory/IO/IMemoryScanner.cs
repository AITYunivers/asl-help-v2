...
public interface IMemoryScanner
{
    ...
    nint Scan(string module, int offset, params string[] pattern);
    nint Scan(string module, int offset, params byte[] pattern);
    ...
    nint Scan(nint startAddress, nint endAddress, int offset, params byte[] pattern);
    nint Scan(nint startAddress, int size, int offset, params string[] pattern);
    nint Scan(nint startAddress, int size, int offset, params byte[] pattern);

    nint ScanRel(int offset, params string[] pattern);
    nint ScanRel(int offset, params byte[] pattern);
    nint ScanRel(string module, int offset, params string[] pattern);
    nint ScanRel(string module, int offset, params byte[] pattern);
    ...
    nint ScanRel(nint startAddress, nint endAddress, int offset, params byte[] pattern);
    nint ScanRel(nint startAddress, int size, int offset, params string[] pattern);
    nint ScanRel(nint startAddress, int size, int offset, params byte[] pattern);

    IEnumerable<nint> ScanAll(int offset, params string[] pattern);
    IEnumerable<nint> ScanAll(int offset, params byte[] pattern);
    IEnumerable<nint> ScanAll(string module, int offset, params string[] pattern);
    IEnumerable<nint> ScanAll(string module, int offset, params byte[] pattern);
    ...
    IEnumerable<nint> ScanAll(nint startAddress, nint endAddress, int offset, params byte[] pattern);
    IEnumerable<nint> ScanAll(nint startAddress, int size, int offset, params string[] pattern);
    IEnumerable<nint> ScanAll(nint startAddress, int size, int offset, params byte[] pattern);

    IEnumerable<nint> ScanAllRel(int offset, params string[] pattern);
    IEnumerable<nint> ScanAllRel(int offset, params byte[] pattern);
    IEnumerable<nint> ScanAllRel(string module, int offset, params string[] pattern);
    IEnumerable<nint> ScanAllRel(string module, int offset, params byte[] pattern);
    ...
    IEnumerable<nint> ScanAllRel(nint startAddress, nint endAddress, int offset, params byte[] pattern);
    IEnumerable<nint> ScanAllRel(nint startAddress, int size, int offset, params string[] pattern);
    IEnumerable<nint> ScanAllRel(nint startAddress, int size, int offset, params byte[] pattern);

    nint ScanPages(int offset, params string[] pattern);
    nint ScanPages(int offset, params byte[] pattern);
    nint ScanPages(bool allPages, int offset, params string[] pattern);
    nint ScanPages(bool allPages, int offset, params byte[] pattern);
    nint ScanPagesRel(int offset, params string[] pattern);
    nint ScanPagesRel(int offset, params byte[] pattern);
    nint ScanPagesRel(bool allPages, int offset, params string[] pattern);
    nint ScanPagesRel(bool allPages, int offset, params byte[] pattern);
    IEnumerable<nint> ScanPagesAll(int offset, params string[] pattern);
    IEnumerable<nint> ScanPagesAll(int offset, params byte[] pattern);
    IEnumerable<nint> ScanPagesAll(bool allPages, int offset, params string[] pattern);
    IEnumerable<nint> ScanPagesAll(bool allPages, int offset, params byte[] pattern);
    IEnumerable<nint> ScanPagesAllRel(int offset, params string[] pattern);
    IEnumerable<nint> ScanPagesAllRel(int offset, params byte[] pattern);
    IEnumerable<nint> ScanPagesAllRel(bool allPages, int offset, params string[] pattern);
    IEnumerable<nint> ScanPagesAllRel(bool allPages, int offset, params byte[] pattern);

    nint Scan(Signature signature, int alignment = 1);
    nint Scan(Signature signature, int size, int alignment = 1);
    nint Scan(Signature signature, string module, int alignment = 1);
    nint Scan(Signature signature, string module, int size, int alignment = 1);
    ...
    nint ScanRel(Signature signature, string module, int alignment = 1);
    nint ScanRel(Signature signature, string module, int size, int alignment = 1);
    ...
    IEnumerable<nint> ScanAll(Signature signature, string module, int alignment = 1);
    IEnumerable<nint> ScanAll(Signature signature, string module, int size, int alignment = 1);
    ...
    IEnumerable<nint> ScanAllRel(Signature signature, string module, int alignment = 1);
    IEnumerable<nint> ScanAllRel(Signature signature, string module, int size, int alignment = 1);
