...
internal partial class NetFx20Dictionary<TKey, TValue>
{
    private struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>>, IEnumerator
    {
        private readonly NetFx20Dictionary<TKey, TValue> _dictionary;

        private int _next;

        public Enumerator(NetFx20Dictionary<TKey, TValue> dictionary)
        {
